	...
	<!-- popup window -->
		...
		<div class="grid_10">
			<div class="box round first">
				<h2>Charger un fichier csv des nodes</h2>
				<div class="block">
					...
					<form action='<s:property value="rootUrl"/>nodes/load' enctype="multipart/form-data" method="post" onsubmit="popupMedi('Cette opération peut prendre plusieurs minutes, Veuillez patienter...');" >
						<table class="form">
							<tr>
								<td>Fichier CSV:</td>
