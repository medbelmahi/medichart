	...
	<!-- popup window -->
		...
		<div class="grid_10">
			<div class="box round first">
				<h2>Supprimer tous les interfaces logiques</h2>
				<div class="block">
					...
					<ul class="message warning">
						<li>
							...
							Tous les trafics seront supprimées egalement.
						</li>
					</ul>
					...
					<form action='<s:property value="rootUrl"/>interfaces/deleteAll' method="post" onsubmit="popupMedi('Cette opération peut prendre plusieurs minutes, Veuillez patienter...');" >
						<table class="form">
							<tr>
