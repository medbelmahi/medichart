	...
	<!-- popup window -->
		...
		<div class="grid_10">
			<div class="box round first">
				<h2>Charger un fichier csv des interfaces</h2>
				<div class="block">
					<!-- Message Error & Info & warning -->
					<ul class="message warning">
						<li>
							NB: Cette opération peut prendre plusieurs minutes, Veuillez patienter...
						</li>
					</ul>
					...
					<form action='<s:property value="rootUrl"/>interfaces/load' enctype="multipart/form-data" method="post" onsubmit="popupMedi('Cette opération peut prendre plusieurs minutes, Veuillez patienter...');" >
						<table class="form">
							<tr>
								<td>Fichier CSV:</td>
								<td><s:file name="upload" cssClass="medium" required="required" /></td>
							</tr>
							<tr>
								<td>Délimiteur:</td>
								<td><s:textfield cssClass="medium" name="delimiteur" value="," required="required" /></td>
							</tr>
							<tr>
								<td>Commencer à:</td>
								<td><s:textfield cssClass="medium" name="startLine" value="1" required="required" /></td>
							</tr>
							<tr>
								<td></td>
								<td><input type="submit" class="medium" value="Charger"></td>
							</tr>
						</table>
					</form>
				</div>
