	...
	<div class="container_12">
		...
		<div class="grid_10">
            <div class="box round first grid">
                <h2>La liste des interfaces physiques</h2>
                <div class="block">
                	<!-- Message Error & Info & warning -->
					<ul class="message warning">
						<li>NB: Notez-vous que l'interface sera <strong>supprimé automatiquement</strong> sans confirmation</li>
					</ul>
					...
					<tbody>
						<s:iterator value="listInterfacesPhysics" var="interface">
						<tr class="odd gradeX">
							<td><s:property value="nameInterfacePhysic" /></td>
							<td><s:property value="indexInterfacePhysic" /></td>
							<td><s:property value="node.nodeName" /></td>
							
							<s:url action="remove" var="removeUrl">
								<s:param name="idInterfacePhysic"><s:property value="idInterfacePhysic" /></s:param>
							</s:url>
