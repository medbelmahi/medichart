	...
	<!-- popup window -->
		...
		<div class="grid_10">
			<div class="box round first">
				<h2>Supprimer tous les nodes</h2>
				<div class="block">
					<!-- Message Error & Info & warning -->
					<ul class="message warning">
						<li>
							NB: Notez-vous que les nodes seront <strong>supprimées automatiquement</strong> sans confirmation. 
							Tous les interfaces physiques / logiques seront supprimées egalement.
						</li>
					</ul>
					...
					<form action='<s:property value="rootUrl"/>nodes/deleteAll' method="post" onsubmit="popupMedi('Cette opération peut prendre plusieurs minutes, Veuillez patienter...');" >
						<table class="form">
							<tr>
								<td><input name="confirme" type="checkbox"  required="required" />Veuillez confirmer la suppression</td>
							</tr>
							<tr>
								<td><input type="submit" value="Supprimer tous les nodes"></td>
								<td></td>
							</tr>
						</table>
					</form>
